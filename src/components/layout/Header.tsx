  ...
  return (
    <header
      className={cn(
        ...
        isScrolled
          ? "bg-background/90 backdrop-blur-md border-b border-charcoal/10 shadow-[0_1px_0_0_rgba(0,0,0,0.02)]"
          ...
          {primaryNav.map((item) => {
              ...
              return (
                ...
                >
                  <Link
                    href={item.href}
                    className={cn(
                      "flex items-center gap-1 rounded-full px-4 py-2 text-sm font-medium transition-colors hover:text-forest focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-forest",
                  ...
                  <AnimatePresence>
                    {isServicesOpen && (
                      ...
                      >
                        <ul className="rounded-2xl border border-charcoal/10 bg-white p-2 shadow-lg shadow-charcoal/5">
            ...
            return (
              <Link
                ...
                href={item.href}
                className={cn(
                  "rounded-full px-4 py-2 text-sm font-medium transition-colors hover:text-forest focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-forest",
                  isActive ? "text-forest" : "text-charcoal"
                )}
              >
                {item.label}
